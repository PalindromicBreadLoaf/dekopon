...
if(NOT EXISTS "${UAM_ROOT}/source/compiler_iface.cpp")
    message(FATAL_ERROR
        ...
        "Clone it next to the dekopon checkout (git clone https://github.com/devkitPro/uam) or "
        "point UAM_ROOT at an existing one.")
endif()
...
set(_uam_bridge "${CMAKE_SOURCE_DIR}/src/video_core/renderer_deko3d/uam_bridge.cpp")
set(_uam_stderr "${CMAKE_SOURCE_DIR}/src/video_core/renderer_deko3d/uam_stderr.h")
...
target_compile_definitions(uam_objects PRIVATE
    ...
    DESKTOP
    _USE_MATH_DEFINES
    # uam's meson pre_args
    _GNU_SOURCE
    HAVE_POSIX_MEMALIGN
    NDEBUG
)

# mesa 19.0 predates C++14 and only comes kicking and screaming into the modern era.
...
target_compile_options(uam_objects PRIVATE -w -Wno-error -fno-lto -include "${_uam_stderr}")
